...
Usage: swoosh adopt [OPTIONS] [invite]
  ...
  --force    re-root this machine when the invite names a different signet than the one it trusts
```
...
one this machine already trusts is refused unless you pass `--force`. A bare invite argument warns you
