...
impl TunnelExposeCmd {
        ...
        <T::Session as Session>::Read: Send + 'static,
    {
        ...
        // The core assembles the exposer, enforcing the sshd-cannot-be-public invariant before any banner
        // is printed, so a refused pairing never advertises a shell it will not serve.
